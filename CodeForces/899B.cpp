...
freopen("output.txt","w",stdout);
	...
	// w(t){
  		...
  		// 	return cout<<"No",0;
  		// }
  		std::vector<lli> v2{31,28,31,30,31,30,31,31,30,31,30,31,31,28,31,30,31,30,31,31,30,31,30,31};
  		std::vector<lli> v3{31,29,31,30,31,30,31,31,30,31,30,31,31,28,31,30,31,30,31,31,30,31,30,31};
  		for(lli i =0;i<=23;i++){
  			lli f=0;
  			if(v1[0]==v2[i]){

  				for(lli j=1;j<n;j++){
  					// cout<<i<<" "<<j<<" "<<v2[(i+j)%24]<<" "<<v1[j]<<" "<<endl;
  					if(v1[j]!=v2[(i+j)%24]){
  						// cout<<"yes1"<<endl;
  						f=1;
  						break;
